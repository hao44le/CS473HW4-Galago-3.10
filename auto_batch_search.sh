...
core/target/appassembler/bin/galago eval --judgments=CS473HW/cacm.rel --runs+CS473HW/outputTFIDF.txt --metrics+map --metrics+ndcg --metrics+P3 >> CS473HW/result.txt

core/target/appassembler/bin/galago eval --judgments=CS473HW/cacm.rel --runs+CS473HW/outputLogTFIDF.txt --metrics+map --metrics+ndcg --metrics+P3 >> CS473HW/result.txt

core/target/appassembler/bin/galago eval --judgments=CS473HW/cacm.rel --runs+CS473HW/outputCosine.txt --metrics+map --metrics+ndcg --metrics+P3 >> CS473HW/result.txt

core/target/appassembler/bin/galago eval --judgments=CS473HW/cacm.rel --runs+CS473HW/outputBM25.txt --metrics+map --metrics+ndcg --metrics+P3 >> CS473HW/result.txt

core/target/appassembler/bin/galago eval --judgments=CS473HW/cacm.rel --runs+CS473HW/outputJM.txt --metrics+map --metrics+ndcg --metrics+P3 >> CS473HW/result.txt
